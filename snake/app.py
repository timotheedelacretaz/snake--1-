...
def our_snake(snake_list):
    ...
    for x in snake_list[1:len(snake_list)-1]:
        pygame.draw.rect(game_window,white, [x[0], x[1], unit*modgrowth, unit*modgrowth])
...
while running:
    ...
    if gstate == 'start':
        ...
        pygame.draw.rect(game_window,black, [window_x/4-10, window_y/6-10, window_x/2+20,window_y/2+20])
        pygame.draw.rect(game_window,white, [window_x/4-5, window_y/6-5, window_x/2+10,window_y/2+10])
        pygame.draw.rect(game_window,colorpicker, [window_x/4, window_y/6, window_x/2,window_y/2])
        ...
        for x in wallposition:
            pygame.draw.rect(game_window, white, pygame.Rect(x[0], x[1], unit*modgrowth, unit*modgrowth))
